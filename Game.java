...
public class Game implements Constants {
	...
	public static void main(String[] args) throws IOException {
		...
		xPlayer = create_player (name, LETTER_X, theGame.theBoard, stdin, r);
		...
		oPlayer = create_player (name, LETTER_O, theGame.theBoard, stdin, r);
	...
	static public Player  create_player(String name, char mark, Board board,
			BufferedReader stdin, RandomGenerator r)throws IOException {
		// Get the player type.
		...
		switch(player_type) {
			case 1:
				...
				break;
			case 2:
				result = new RandomPlayer(name, mark, r);
				break;
			case 3:
				result = new BlockingPlayer(name, mark, r);
				break;
			case 4:
				result = new SmartPlayer(name, mark, r);
				break;
			default:
